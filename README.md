...
Using a collection of 5,701 speeches collected from the TED website [What Is TED?](#data), this project will take the following steps:
...
The first dataset used (sourced from Kaggle.com) can be found [here](https://www.kaggle.com/datasets/miguelcorraljr/ted-talks-2022). It's data dictionary can be found below.

The second dataset used (sourced from Kaggle.com) can be found [here](https://www.kaggle.com/datasets/miguelcorraljr/ted-ultimate-dataset/data). It's data dictionary can be found below.
...
This dataset is used because it contains the transcript for each talk given.  It was last updated on April 30th, 2020, and therefore contains fewer talks than Dataset #1 which was updated on October 13th, 2022.
...
- A notebook for merging the likes and views from Dataset #1 into Dataset #2.
